...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
          <div class="flex justify-between">
            <h2 class="text-2xl font-bold mb-4">Manage User Account</h2>
            <button id="downloadButton" class="p-2 bg-blue-400 mb-4 rounded">Print Users</button>
        </div>
            ...
            <table class="w-full border text-center">
                <thead id="tablehead">
                    <tr>
                        ...
                        <th class="p-2 border actions">Actions</th>
                    </tr>
                </thead>
                <tbody id="userTable">
...
document.getElementById('downloadButton').addEventListener('click', () => {
            ...
            const headers = [];
            tableHead.querySelectorAll('th').forEach(header => {
